...
struct TicketView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let ticket3 = Ticket(product: "Realm", title: "Issue three", details: "This is not such a big deal. But I do want to talk about it at greate length. This is not such a big deal. But I do want to talk about it at greate length.", author: "Jane")
